 ...
 */
metadata {
	definition(name: "Zemismart child switch health - icon light", namespace: "niquini", author: "Wanderson Niquini", mnmn: "SmartThings", ocfDeviceType: "oic.d.light", vid: "generic-switch") {
		capability "Switch"
		capability "Actuator"
		capability "Sensor"
