/**
 *  Tasmota generic switch - icon water valve
 *
...
metadata {
    definition(name: "Tasmota generic switch - icon water valve", namespace: "niquini", author: "Wanderson Niquini", ocfDeviceType: "oic.d.watervalve") {
        capability "Actuator"
