/*
 *  Zemismart zigbee switch touch - icon light
 * 
 *  Copyright 2020 SmartThings - niquini.com
 *
...
metadata {
    definition(name: "Zemismart zigbee switch touch - icon light", namespace: "niquini", author: "Wanderson Niquini", ocfDeviceType: "oic.d.light", vid: "generic-switch") {
        capability "Actuator"
