...
def moduleMap() {
    ...
    def defaultModule = [
         ...
         "Tasmota generic switch - icon light":          [channel: 1, messaging: false,   virtual: false, child: false, settings: ["ip"]],
         "Tasmota generic switch - icon water valve":    [channel: 1, messaging: false,   virtual: false, child: false, settings: ["ip"]],
