/**
 *  Tasmota generic switch - icon light
 *
 *  Copyright 2020 niquini.com
 *
...
metadata {
    definition(name: "Tasmota generic switch - icon light", namespace: "niquini", author: "Wanderson Niquini", ocfDeviceType: "oic.d.light") {
        capability "Actuator"
